...
> tl;dr: use whatever computer you previously used as your workstation, if it has an ethernet port youŕe good to go, if not get a PCIe ethernet card (for a desktop) or a USB-Ethernet adapter (for a laptop).
