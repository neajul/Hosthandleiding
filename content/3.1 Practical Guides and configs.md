...
This last step should close the `fdisk` menu. At this point we just need to unmount the device, and create the file system. To do this enter these two commands (Replace `[DEVICEPATH]` with your *device path*, as above):
